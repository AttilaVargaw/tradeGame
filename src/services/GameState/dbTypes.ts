...
export type Tables = 'VehicleData' | 'Convoy' | 'Vehicle' | 'VehicleTypes' | 'TradeRoutes' | 'CityTypes' | 'Translations' | 'ClassDailyRequirement' | 'City' | 'IndustrialBuildingDailyRequirement' | 'IndustrialBuilding' | 'PopulationClass' | 'CityWarehouse' | 'Item' | 'CityPopulationClass' | 'IndustrialBuildings'
