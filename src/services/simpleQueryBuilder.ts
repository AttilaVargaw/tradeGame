...
function whereEquationToString<T>({
  operator = "=",
  A,
  AAttr,
  value = null,
...
function joinEquitationToString<T, U>({
  operator = "=",
  A,
  B,
  BAttr,
...
>(
  selectRows: (
    ...
    | {
        table?: Tables | string;
        row: Attr1 & Attr2 & Attr3 & Attr4 & Attr5 & Attr6;
        as?: string;
      }
    | string
  )[],
  ...
  >[],
  join?: Join<
    Attr1 | Attr2 | Attr3 | Attr4 | Attr5 | Attr5 | Attr6,
    Attr1 | Attr2 | Attr3 | Attr4 | Attr5 | Attr5 | Attr6
  >[]
) {
